      ...
      if (typeof api.registerCommand === "function") {
        ...
        const plur1busHelp = (mode = "quick") => ({
          text: mode === "advanced" ? [
            ...
            "",
            "The bundle id is optional in Telegram replies and short commands.",
            "Without an id: show/explain/approve/reject use the latest pending bundle; apply uses the latest approved bundle.",
          ].join("\n") : [
            ...
            "Morning, evening, review, and approve do not write memory. Apply only writes memory for memory-candidate items.",
            "Bundle id is optional: reply with approve/reject/apply/quickapply, or use the short commands without an id.",
