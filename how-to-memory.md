...
*Änderungen 2026-04-03 (Security): SQL-Injection-Fix (UUID-Validation), atomares Lock-File (wx-Flag + Staleness), JSON-Parse-Fehlerbehandlung, Embedding-Retry mit Backoff, Auto-Capture Promise-Queue, GC-Pfade relativ*
