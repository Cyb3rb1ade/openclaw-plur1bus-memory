...
FEATURES: tuple[dict[str, str], ...] = (
    ...
    {"id": "embedding-cache", "status": "partial", "evidence": "agent-scoped persistence and single-request coalescing; batched in-flight coalescing and exact soft-byte pruning differ"},
...
COVERAGE_710 = (
    ...
    {"id": "store-merge-lineage", "status": "partial", "detail": "explicit lossless-concatenation proposals, stable IDs, validity lineage, approved revision and final revalidation; interrupted materialization requires repair; automatic store-time LLM merge remains absent"},
