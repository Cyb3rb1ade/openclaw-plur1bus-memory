...
class ParityTests(unittest.TestCase):
    def test_report_does_not_hide_required_gaps_or_exclude_native_workshop(self):
        ...
        self.assertEqual(by_id["skill-farming"]["status"], "partial")
        ...
        self.assertEqual(coverage["skill-workshop"]["status"], "partial")
