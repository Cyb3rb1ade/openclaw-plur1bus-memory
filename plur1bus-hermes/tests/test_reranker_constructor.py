...
class RerankerConstructorTests(unittest.TestCase):
    def test_cache_dir_and_bounded_input_use_real_constructor_keyword_names(self):
        calls = []
        def encoder(model_name, *, cache_dir, max_length, trust_remote_code):
            calls.append((model_name, cache_dir, max_length, trust_remote_code))
        ...
        with tempfile.TemporaryDirectory() as temporary, patch.dict(
            ...
            self.assertEqual(calls[0][2:], (512, False))
