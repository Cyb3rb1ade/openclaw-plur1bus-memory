...
[![Release](https://img.shields.io/badge/release-v4.2.18-blue)](https://github.com/Cyb3rb1ade/openclaw-plur1bus-memory/releases/tag/v4.2.18)
...
installieren. In `4.2.18` fuehrt PLUR1BUS solche Cron-Slash-Commands vor der
Modellantwort plugin-intern aus und registriert Telegram-kompatible
Shortcut-Commands fuer die sichtbare Bot-Command-Liste. In `4.2.18` trennt die
...
`obsidianBridgeVersion: 4.2.18`. Jedes Item hat stabile IDs, Status, Risk,
...
Provider status in `4.2.18`: OpenAI/OpenAI-compatible embeddings, Cohere
...
Obsidian Bridge in `4.2.18`: optional, disabled by default, and strictly
