...
[![Release](https://img.shields.io/badge/release-v4.2.15-blue)](https://github.com/Cyb3rb1ade/openclaw-plur1bus-memory/releases/tag/v4.2.15)
...
installieren. In `4.2.15` fuehrt PLUR1BUS solche Cron-Slash-Commands vor der
...
`obsidianBridgeVersion: 4.2.15`. Jedes Item hat stabile IDs, Status, Risk,
...
Provider status in `4.2.15`: OpenAI/OpenAI-compatible embeddings, Cohere
...
Obsidian Bridge in `4.2.15`: optional, disabled by default, and strictly
