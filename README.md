...
**PLUR1BUS 7.8.1 — verified on OpenClaw 2026.8.x and 2026.9.1**

Current source version: **7.8.1**. PLUR1BUS 7.8.1 supports OpenClaw `2026.8.1`
...
### New in v7.8.1 — the dashboard buttons work inside the host tab
...
- OpenClaw embeds the plugin tab in an iframe sandboxed with `allow-scripts`
  ...
  banner. Read-only pages still carry no script.
