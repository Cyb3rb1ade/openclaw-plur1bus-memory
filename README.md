...
[![Release](https://img.shields.io/badge/release-v4.2.7-blue)](https://github.com/Cyb3rb1ade/openclaw-plur1bus-memory/releases/tag/v4.2.7)
...
`obsidianBridgeVersion: 4.2.7`. Jedes Item hat stabile IDs, Status, Risk,
...
Provider status in `4.2.7`: OpenAI/OpenAI-compatible embeddings, Cohere
...
Obsidian Bridge in `4.2.7`: optional, disabled by default, and strictly
