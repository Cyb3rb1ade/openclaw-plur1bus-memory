...
const FEATURE_DEFINITIONS = Object.freeze([
  ...
  { name: "reranker", path: ["reranker", "enabled"], defaultValue: false, dependency: "rerankerRuntime" },
]);

const FEATURE_CARD_DEFINITIONS = Object.freeze([
  { id: "capture", feature: "autoCapture", label: "Capture", dependencies: ["conversation_access"] },
  { id: "recall", feature: "autoRecall", label: "Recall", dependencies: [] },
  { id: "skill-miner", feature: "skillMiner", label: "Skill Miner", dependencies: ["skill_workshop"] },
  { id: "feature-cron", feature: "featureCronSetup", label: "Feature Cron", dependencies: ["cron_dispatch"] },
  { id: "rem", feature: "dreaming", label: "REM", dependencies: ["merging_route"] },
  { id: "obsidian", feature: "obsidianBridge", label: "Obsidian Bridge", dependencies: [] },
  { id: "reranker", feature: "reranker", label: "Reranker", dependencies: ["reranker_runtime"] },
]);
