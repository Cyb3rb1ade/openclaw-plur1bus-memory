...
export function createNeoStore(rootDir, workspaceKey = "default") {
  ...
  return {
    ...
    appendCandidates: (items) => appendJsonlDedupe(paths.candidates, items, { indexPath: paths.index, bucket: "candidateContent", dedupeKey: appendCandidateContentDedupeKey }),
