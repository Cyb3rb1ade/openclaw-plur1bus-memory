...
export class SharedMemoryPool {
  constructor(baseDir, vectorDim, AgentDbPoolClass, logger = null) {
    ...
    this.mode = this.supported ? "fd-capability" : "unavailable";
   ...
   * is `fd-capability`; unsupported always means the platform lacks stable
  ...
  support() {
    return this.supported
      ...
      : { supported: false, mode: this.mode, reason: "platform" };
  }
