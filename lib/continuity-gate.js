 ...
 */
export function filterAssociativeCandidates(candidates, { maxAssociations = 1, sessionState = {} } = {}) {
  const gate = new ContinuityGate({ assocThreshold: 0, maxAssociations });
  const result = [];
 ...
 */
export function filterPatternCandidates(matchedPattern, { maxPatterns = 1, sessionState = {} } = {}) {
