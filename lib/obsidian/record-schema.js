...
export function normalizeRecord(record = {}, options = {}) {
  ...
  return {
    ...
    emotionalIntensity: record.emotionalIntensity ?? 0,
    emotionalDominant: record.emotionalDominant || "neutral",
  };
}
...
export function recordFrontmatter(record = {}) {
  ...
  return {
    ...
    authoritative: false,
    emotional_valence: normalized.emotionalValence || undefined,
    emotional_intensity: normalized.emotionalIntensity || undefined,
    emotional_dominant: normalized.emotionalDominant !== "neutral" ? normalized.emotionalDominant : undefined,
  };
}
