 ...
 */
export const DEFAULT_EMBEDDING_REQUEST_TIMEOUT_MS = 15_000;

/**
 * Per-request timeout for remote embedding calls. The OpenAI SDK defaults to
 * ten minutes; a stalled embedding request then holds a recall until the
 * scheduler's 20-second worker timeout fires (`started=yes elapsedMs=0`).
 */
