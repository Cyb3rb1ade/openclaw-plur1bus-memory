 ...
 *
 * The shape is `HostServices` in types/engine.d.ts (contract 1.2.0).
 *
 ...
 * @param {{clock?: () => number, stateDir?: string|null, platform?: object, events?: {emit: (name: string, payload: unknown) => void}}} [options] Overrides.
...
const STUB_HANDLED_KEYS = Object.freeze([
  ...
  "runtime", "llm", "secrets", "events", "api",
]);
