...
/**
 * VAD mapping for emotional nuances (extended set).
 * @type {Record<string, {v: number, a: number, d: number}>}
 */
const NUANCE_VAD = {
  relief:       { v: 0.50, a: -0.20, d: 0.10 },
  pride:        { v: 0.70, a: 0.30, d: 0.60 },
  gratitude:    { v: 0.80, a: 0.10, d: 0.20 },
  nostalgia:    { v: 0.30, a: -0.10, d: -0.20 },
  loneliness:   { v: -0.60, a: -0.30, d: -0.50 },
  resentment:   { v: -0.50, a: 0.20, d: -0.30 },
  awe:          { v: 0.40, a: 0.70, d: -0.40 },
  contempt:     { v: -0.40, a: 0.20, d: 0.50 },
  guilt:        { v: -0.50, a: -0.10, d: -0.40 },
  shame:        { v: -0.60, a: -0.30, d: -0.60 },
  hope:         { v: 0.60, a: 0.20, d: 0.10 },
  envy:         { v: -0.40, a: 0.30, d: -0.20 },
  compassion:   { v: 0.40, a: 0.20, d: 0.10 },
  curiosity:    { v: 0.30, a: 0.50, d: 0.20 },
  boredom:      { v: -0.20, a: -0.50, d: -0.10 },
  excitement:   { v: 0.70, a: 0.80, d: 0.30 },
  love:         { v: 0.90, a: 0.40, d: 0.20 },
  disappointment:{ v: -0.50, a: -0.20, d: -0.30 },
  embarrassment:{ v: -0.30, a: 0.40, d: -0.50 },
  serenity:     { v: 0.60, a: -0.40, d: 0.30 },
};
...
const LEXICON_EN = {
  ...
  disgusting: "disgust", pathetic: "anger", deserves: "anger",
  // fear
  ...
  // nuances
  relieved: "relief", relief: "relief", reassuring: "relief",
  proud: "pride", pride: "pride", accomplished: "pride",
  grateful: "gratitude", gratitude: "gratitude", thankful: "gratitude",
  nostalgic: "nostalgia", nostalgia: "nostalgia", reminiscent: "nostalgia",
  lonely: "loneliness", loneliness: "loneliness", alone: "loneliness",
  resentful: "resentment", resentment: "resentment", bitter: "resentment",
  awestruck: "awe", awe: "awe", amazed: "awe",
  contemptuous: "contempt", contempt: "contempt", scornful: "contempt",
  guilty: "guilt", guilt: "guilt", remorseful: "guilt",
  ashamed: "shame", shame: "shame", humiliated: "shame",
  hopeful: "hope", hope: "hope", optimistic: "hope",
  envious: "envy", envy: "envy", jealous: "envy",
  compassionate: "compassion", compassion: "compassion", empathetic: "compassion",
  curious: "curiosity", curiosity: "curiosity", inquisitive: "curiosity",
  bored: "boredom", boredom: "boredom", uninterested: "boredom",
  thrilled: "excitement", excitement: "excitement", exhilarated: "excitement",
  love: "love", adore: "love", cherish: "love",
  disappointed: "disappointment", disappointment: "disappointment", letdown: "disappointment",
  embarrassed: "embarrassment", embarrassment: "embarrassment", mortified: "embarrassment",
  serene: "serenity", serenity: "serenity", peaceful: "serenity",
};
...
const LEXICON_DE = {
  ...
  // nuancen
  erleichtert: "relief", erleichterung: "relief", beruhigt: "relief",
  stolz: "pride", stolzsein: "pride", leistung: "pride",
  dankbar: "gratitude", dankbarkeit: "gratitude", erkenntlich: "gratitude",
  nostalgisch: "nostalgia", nostalgie: "nostalgia", schwermütig: "nostalgia",
  einsam: "loneliness", einsamkeit: "loneliness", allein: "loneliness",
  verbittert: "resentment", groll: "resentment", nachtragend: "resentment",
  ehrfurcht: "awe", ehrfürchtig: "awe", beeindruckt: "awe",
  verachtung: "contempt", verächtlich: "contempt", geringschätzung: "contempt",
  schuld: "guilt", schuldig: "guilt", reue: "guilt",
  scham: "shame", beschämt: "shame", demütigt: "shame",
  hoffnungsvoll: "hope", hoffnung: "hope", zuversicht: "hope",
  neid: "envy", neidisch: "envy", eifersüchtig: "envy",
  mitgefühl: "compassion", mitfühlend: "compassion", empathisch: "compassion",
  neugierig: "curiosity", neugier: "curiosity", wissbegierig: "curiosity",
  gelangweilt: "boredom", langeweile: "boredom", desinteressiert: "boredom",
  begeistert: "excitement", aufgeregt: "excitement", enthusiastisch: "excitement",
  liebe: "love", lieben: "love", verehren: "love",
  enttäuscht: "disappointment", enttäuschung: "disappointment", verletzt: "disappointment",
  verlegen: "embarrassment", peinlich: "embarrassment", beschämend: "embarrassment",
  gelassen: "serenity", gelassenheit: "serenity", friedvoll: "serenity",
};
...
export class Tier1LexiconClassifier {
  ...
  classify(text, source = "user") {
    ...
    // For mixed/unknown: search both lexicons equally (primary = de, fallback = en)
    const primaryLex = lang === "en" ? this.lexiconEn : this.lexiconDe;
    const fallbackLex = lang === "en" ? this.lexiconDe : this.lexiconEn;
    ...
    // Get VAD for primary emotion. `primary` may be a NUANCE label (love,
    // gratitude, pride, relief, …) which has no EMOTION_VAD entry — fall back to
    // NUANCE_VAD, then neutral, so vad.v/a/d never become undefined → NaN.
    let vad = { ...(EMOTION_VAD[primary] || NUANCE_VAD[primary] || EMOTION_VAD.neutral) };
    ...
    for (const [emo, count] of Object.entries(emotionCounts)) {
      if (NUANCE_VAD[emo]) {
        const nuanceVad = NUANCE_VAD[emo];
        const nuanceIntensity = Math.min(
          1.0,
          Math.sqrt(nuanceVad.v ** 2 + nuanceVad.a ** 2 + nuanceVad.d ** 2) / Math.sqrt(3)
        );
        nuances.push({
          label: emo,
          intensity: round4(nuanceIntensity),
          confidence: round4(Math.min(1.0, (count / matchedWords) * 1.5 + 0.2)),
          source: "lexicon",
          language: lang,
        });
      }
    ...
    nuances.sort((a, b) => b.intensity - a.intensity);
    ...
    return new EmotionScore({
      ...
      confidence,
      timestamp: new Date(),
      nuances: nuances.slice(0, 5), // max 5 nuances
    });
  }
}
