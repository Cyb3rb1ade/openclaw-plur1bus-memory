...
export const SHARED_DYNAMICS_QUEUE_KEY = "plur1bus.deferredDynamics.v1";

/**
 * 7.12.36: Eine Warteschlange je Prozess. Der Kick nach dem Recall kommt aus
 * der Lauf-Instanz, das Einstellen aus der Gateway-Instanz; ohne gemeinsame
 * Queue griff immer erst die Rueckfallfrist (waitMs=10003 im Log).
 */
export function getSharedDeferredDynamicsQueue(options = {}) {
  return getProcessSingleton(SHARED_DYNAMICS_QUEUE_KEY, () => createDeferredDynamicsQueue(options));
}
