...
export const FEATURE_WHITELIST = {
  ...
  morningReview: {
    configPath: ['plugins', 'entries', 'memory-lancedb-namespaced', 'config', 'morningReview', 'enabled'],
    description: 'Morning Review',
  },
  eveningReview: {
    configPath: ['plugins', 'entries', 'memory-lancedb-namespaced', 'config', 'eveningReview', 'enabled'],
