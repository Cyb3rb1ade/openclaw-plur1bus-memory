...
import { normalizeImportanceStatus } from "./importance-status.js";
...
export function buildUpdateEntry(oldRow, patch, evidence, opts = {}) {
  ...
  return {
    ...
    // inhaltsaendernden Update verlieren — sonst faellt sie aus der
    // Importance-Queue, ohne je bewertet worden zu sein.
    importanceStatus: normalizeImportanceStatus(oldRow.importanceStatus),
