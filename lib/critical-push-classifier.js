 ...
 *
 * Buttons (verständliche Aktionen, keine destruktiven/irreführenden Labels):
 *   „Bestätigen“        → bestätigt die besondere Kennzeichnung
 *   „Nicht hervorheben“ → verwirft nur die Kennzeichnung (löscht NICHT)
 *   „Korrigieren“       → führt in den sicheren Korrekturablauf
 *
 * Callback-Daten enthalten ausschließlich die kanonische UUID (intern).
 * Für Textbefehle wird die Kurzreferenz (`card.shortRef`) angezeigt.
 *
