...
export function resolveWriteNamespace(nsCfg = {}) {
  return normalizeNamespaceConfig(nsCfg, NAMESPACE_CONFIG_PATH).activeWriteNamespace;
}
...
export function resolveRecallReadNamespaces(nsCfg = {}) {
  return normalizeNamespaceConfig(nsCfg, NAMESPACE_CONFIG_PATH).recallReadNamespaces;
}
...
export function isLegacyReadOnly(namespaceName, nsCfg = {}) {
  return normalizeNamespaceConfig(nsCfg, NAMESPACE_CONFIG_PATH).legacyReadOnlyNamespaces.includes(namespaceName);
}
