...
export class EmotionEngine {
  ...
  constructor(config = {}) {
    ...
    /** @type {boolean} — Budget-Gate: t3 darf nur laufen wenn explizit enabled + API-Key oder Client */
    this._t3Enabled = config.tier3?.enabled === true && (!!config.tier3?.apiKey || !!config.tier3?.openaiClient);
