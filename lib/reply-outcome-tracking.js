...
/**
 * Reads reply-outcome log entries newest-first with optional tail limits and
 * optional bounded file reads passed through to readJsonl.
 *
...
export function readReplyOutcomeLog(workspaceDir, limitOrOptions = 0, maybeOptions = {}) {
  ...
  const entries = readJsonl(logPath(workspaceDir), options);
