...
// 7.12.37: 400 Zeichen stammten aus der Zeit mit drei Seed-Bullets. Seit der
// Block bis zwoelf Zeilen wachsen darf, schnitt der Deckel bei allen drei
// Agenten die praegenden Zeilen ab (Bernhardine: 3 von 7 sichtbar, Marotte,
// Ironie und Anrede fehlten; 10.09.2026) — und jede Weiterentwicklung
// haengt am Ende, also im unsichtbaren Teil. Zwoelf Zeilen zu je ~130
// Zeichen plus Praefix passen in 1600.
export const DEFAULT_MAX_DIRECTIVE_CHARS = 1600;
...
// Bullet-Zeilen. Der Seed ist strukturell durch die SEED_END-Boundary
// begrenzt: ALLE Bullets vor der Boundary sind geschützt, entfernt wird
// immer die älteste Bullet-Zeile NACH der Boundary. Legacy-Fallback (Dateien
// von vor der Boundary-Einführung, ohne SEED_END im Block): die ersten
// LEGACY_SEED_BULLETS=3 Bullets gelten als Seed — das entspricht exakt dem
// Verhalten vor dieser Änderung und dem Minimum, das writePersonaVoice je
// als Seed akzeptiert hat.
 ...
 *
 * @param {{workspaceDir: string, outcomes?: Array<object>, llmCfg?: object|null, callLlm?: Function|null, now?: number, signal?: AbortSignal}} params
 * @returns {Promise<{evolved: boolean, reason?: string, marker?: string}>}
 */
export async function evolvePersonaVoice({ workspaceDir, outcomes = [], llmCfg = null, callLlm = null, now = Date.now(), signal = null } = {}) {
  try {
