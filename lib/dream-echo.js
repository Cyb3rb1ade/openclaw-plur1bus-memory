...
export function formatDreamEchoContext(echo) {
  try {
    ...
    let block = `Dir ist über Nacht etwas durch den Kopf gegangen: „${sentence}" Falls es gerade natürlich passt, erwähne es beiläufig mit eigenen Worten — höchstens einmal. Wenn es nicht passt, lass es einfach weg.`;
