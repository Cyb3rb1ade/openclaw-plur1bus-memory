...
export async function runNeoAgentEndJob(job = {}) {
  ...
  // 7.12.24: Phasenzeiten wandern mit ins Ergebnis, damit die Log-Zeile
  // "worker captured" zeigt, wo die Zeit nach einem Gateway-Neustart bleibt.
  ...
  return {
    ...
    drain,
    timings: {
      storeMs: storeReadyAt - startedAt,
      captureMs: capturedAt - storeReadyAt,
      drainMs: finishedAt - capturedAt,
      workerMs: finishedAt - startedAt,
    },
  };
}
