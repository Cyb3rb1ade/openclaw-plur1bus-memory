...
export async function normalizeCommandInput({
  ...
  // Ehrliches Flag: nur als "komprimiert" markieren, wenn das Ergebnis
  // tatsächlich kürzer ist (ein einzelner überlanger Satz ohne Satzzeichen
  // kann unverändert durchlaufen).
