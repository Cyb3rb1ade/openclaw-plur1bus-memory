...
const FILLER_WORDS = new Set([
  ...
  "naja", "tja", "hm", "ähm", "alsooo", "irgendwie", "irgendwo", "irgendwann",
  ...
  "also", "so", "dann", "und so", "und so weiter", "usw", "etc",
  "halt", "einfach", "nur", "bloß", "gerade", "mal", "nochmal", "wieder",
  "schon", "doch", "ja", "ne", "oder", "weißt du", "verstehst du",
  "weißt", "verstehst", "gell", "ne", "oder", "halt", "eben", "so",
]);
