 ...
 */
export function summarizeLancedbOptimize(stats = {}, before = null, after = null, extra = {}) {
  ...
  return {
    ...
    // 7.12.45/46: Anzahl der Optimize-Anlaeufe (Retry bei Commit-Konflikt).
    attempts: Number.isFinite(Number(extra?.attempts)) ? Number(extra.attempts) : 1,
  };
}
