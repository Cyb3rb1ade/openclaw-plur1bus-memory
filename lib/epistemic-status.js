 ...
 * @param {"human"|"system:tombstone-cascade"} actorTier
 * @returns {boolean}
 */
export function isLegalEpistemicTransition(fromStatus, nextStatus, actorTier) {
  ...
  if (actorTier !== HUMAN && actorTier !== CASCADE) return false;
 ...
 * @param {"human"|"system:tombstone-cascade"} [opts.actorTier="human"]
