...
export const REQUIRED_FEATURE_CRONS = [
  ...
  },
  {
    ...
    // erzeugt, und nach persona-evolve (sonntags 04:15). runGcJob iteriert
    // selbst über alle Agent-Datenbanken, deshalb genügt ein Lauf; ein Job je
    // Agent würde denselben Bestand mehrfach durcharbeiten.
...
export function selectEnabledFeatureCronSpecs(sourceConfig) {
  ...
  // deshalb erst, wenn `gc` ausdrücklich eingeschaltet ist.
