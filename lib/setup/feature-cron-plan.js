...
export const REQUIRED_FEATURE_CRONS = [
  ...
  },
  {
    ...
    // Must remain byte-for-byte identical to command. Exact plugin commands
    // bypass OpenClaw's outer agent/model turn; the plugin handler itself
    // returns either the composed text or the NO_REPLY suppression token.
  ...
  },
  {
    ...
    // See afterthought above: the command handler performs delivery-result
    // formatting directly, without a model-backed carrier.
