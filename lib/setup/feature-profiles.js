...
function migrateLegacyPluginEntry(entry) {
...
/**
 * Apply an explicit profile to a cloned OpenClaw document.
...
export function applyFeatureProfile(existingConfig, profile, opts = {}) {
  ...
  const pluginEntry = migrateLegacyPluginEntry(merged.plugins.entries[PLUGIN_KEY]);
