...
function renderProjection(projection) {
  ...
  const refreshSeconds = activeReembeddingRefreshSeconds(status.reembeddingWorkflow);
  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
