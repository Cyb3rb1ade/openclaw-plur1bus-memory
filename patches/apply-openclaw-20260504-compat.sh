...
try:
    ...
    pass
supported_versions = {"2026.5.4", "2026.5.5", "2026.5.6", "2026.5.7"}
if pkg_version and pkg_version not in supported_versions:
    print(f"[patch] OpenClaw 2026.5.4/2026.5.5/2026.5.6/2026.5.7 compat: package version is {pkg_version}, skipping dist patch")
    raise SystemExit(0)
